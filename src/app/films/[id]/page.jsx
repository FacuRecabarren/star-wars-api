...
const FilmDetail = ({ params }) => {
    ...
    if (!film) {
        return <img src="https://res.cloudinary.com/dreso9ye9/image/upload/v1715273713/Prueba%20t%C3%A9cnica/peter-gargiulo-cGNCepznaV8-unsplash_l83qqz.jpg" alt="" className='fixed h-full w-full object-cover -z-10'/>;
    }
    ...
    return (
        <div className='h-full flex flex-col justify-center items-center bg-[url(https://res.cloudinary.com/dreso9ye9/image/upload/v1715273713/Prueba%20t%C3%A9cnica/peter-gargiulo-cGNCepznaV8-unsplash_l83qqz.jpg)] bg-fixed bg-cover pb-10'>
            <section className='flex justify-center items-start gap-20 pt-44 h-full'>
